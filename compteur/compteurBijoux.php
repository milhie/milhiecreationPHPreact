...
function compteur($Afficher=0){
    ...
    $CheminStats="compteur/statsBijoux.txt";
    /*
    Utilisation:
...
echo "Le site comptabilise ".compteur(1)." visite(s) aujourd'hui et ".compteur(2)." au total depuis le 18/04/2020 sur la page 'bijoux'!";
?>