<!--Script du compteur trouvé sur ce site:  https://www.c2script.com/scripts/compteur-de-visites-sans-base-de-donnees-s17.html-->
<?php
...
function compteur($Afficher=0){
    ...
    $CheminStats="compteur/statsDecosMariage.txt";
    /*
    Utilisation:
...
echo "Le site comptabilise ".compteur(1)." visite(s) aujourd'hui et ".compteur(2)." au total depuis le 18/04/2020 sur la page 'décorations de mariage!";
?>